 ...
 /**
    ...
    public function __construct() {
        parent::__construct(
            ...
            'Clock', // Name
            ['description' => __( 'A Clock Widget', 'hammersportmarketing' ), ] // Args
        );
    }
    ...
    public function form( $instance ) {
        if ( isset( $instance[ 'title' ] ) ) {
            ...
            $title = __( 'Clock', 'hammersportmarketing' );
        }
        ?>
        <p>
            <label for="<?php echo $this->get_field_name( 'title' ); ?>"><?php _e( 'Title:', 'hammersportmarketing' ); ?></label>
